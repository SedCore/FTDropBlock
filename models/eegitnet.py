...
def EEGITNet(out_class, Chans=22, Samples=1125, drop_rate=0.4, dropType='Dropout', blocksize=15):
    ...
    block_in = FTDropBlock2D(drop_rate, block_size=blocksize, tensorformat='NHWC')(block) if dropType == 'FTDropBlock2D' else Dropout(drop_rate)(block)
    ...
    block = FTDropBlock2D(drop_rate, block_size=blocksize, tensorformat='NHWC')(block) if dropType == 'FTDropBlock2D' else Dropout(drop_rate)(block)
